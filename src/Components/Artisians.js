...
const Artisians = ({ title, image, details }) => {
    return (
        <div className="w-full flex flex-col items-center gap-12 py-2 bg-[#545454] rounded-2xl drop-shadow-2xl">
            ...
            <div className="flex min-h-[11rem]">
                <h1 className="text-white text-[14px] sm:px-20 px-4 sm:text-left text-justify">{details}</h1>
            </div>
