    ...
    return (
        <div className="flex w-full justify-center">
            <ul className="hero flex w-full justify-center">
                <li className="hero">
                    <img src={Main} className="w-[90vw] h-[85vh]  rounded-2xl" />
                </li>
                <li className="hero">
                    <img src={One} className="w-[90vw] h-[85vh]  rounded-2xl" />
                </li>
                <li className="hero">
                    <img src={Two} className="w-[90vw] h-[85vh]  rounded-2xl" />
                </li>
                <li className="hero">
                    <img src={Three} className="w-[90vw] h-[85vh]  rounded-2xl" />
                </li>
            </ul>
        </div>
    );
