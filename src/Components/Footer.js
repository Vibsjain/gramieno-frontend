    ...
    return (
        <div className="w-full py-4 sm:mt-10 mt-8 " id="contact">
            <div className="w-full flex justify-center items-center">
                <div className="sm:w-8/12 w-10/12 sm:h-[3px] h-[1px] bg-[#B89C7D] rounded-xl"></div>
            </div>
            <div className="w-full flex sm:flex-row flex-col">
                <div className="sm:w-4/12 w-full sm:p-12 p-4 flex flex-col items-center">
                    ...
                    >
                        <SiGmail className="text-2xl text-[#FF0000]" />
                ...
                <div className="sm:w-4/12 w-full sm:p-12 p-4 flex flex-col gap-4">
                    {footerLinks.map((link, index) => {
                        return (
                            <button
                                className="sm:text-[18px] text-[16px]  sm:text-left"
                                key={index}
                ...
                <div className="sm:w-4/12 w-full sm:p-12 p-4 sm:mt-0 mt-8">
                    <h1 className="sm:text-[18px] text-[16px] text-center font-bold">
                        Gramien’O by
                    </h1>
                    <h1 className="sm:text-[18px] text-[16px] text-center font-bold">
