    ...
    return (
        <div className="back">
            ...
            <div className="sm:px-12 px-4 ">
                <MobileTitle title="Terms and Conditions" />
                <div className={divStyle}>
                    <h1 className={boldFontStyle}>Overview</h1>
                    <h1>
                        This website is operated by Gramien'O. Throughout the
                        site, the terms “we”, “us” and “our” refer to Gramien'O.
                        Gramien'O offers this website, including all
                        information, tools and services available from this site
                        to you, the user, conditioned upon your acceptance of
                        all terms, conditions, policies and notices stated here.
                    </h1>
                    <h1>
                        By visiting our site and/ or purchasing something from
                        us, you engage in our “Service” and agree to be bound by
                    ...
                    <h1>
                        ...
                        Service at any time on this page. We reserve the right
                        to update, change or replace any part of these Terms of
                        Service by posting updates and/or changes to our
                ...
                <div className={divStyle}>
                    ...
                    <h1>
                        ...
                        of a destructive nature. A breach or violation of any of
                        the Terms will result in an immediate termination of
                        your Services.{" "}
                    </h1>
                </div>
                <hr />
                ...
                <div className={divStyle}>
                    ...
                    <h1>
                        ...
                        <br /> We shall not be liable to you or to any
                ...
                <div className={divStyle}>
                    ...
                    <h1>
                        ...
                        offer. All descriptions of products or product pricing
                        are subject to change at anytime without notice, at the
                ...
                <div className={divStyle}>
                    ...
                    <h1>
                        ...
                        credit card numbers and expiration dates, so that we can
                        complete your transactions and contact you as needed.
                    </h1>
                    <h1>For more detail, please review our Returns Policy. </h1>
                </div>
                <hr />
                <div className={divStyle}>
                    <h1 className={boldFontStyle}>
                    ...
                    <h1>
                        ...
                        should ensure that you are familiar with and approve of
                        the terms on which tools are provided by the relevant
                        third-party provider(s). We may also, in the future,
                        offer new services and/or features through the website
                        (including, the release of new tools and resources).
                        Such new features and/or services shall also be subject
                ...
                <div className={divStyle}>
                    ...
                    <h1>
                        ...
                        the Service or any related website. You may not use a
                        false e‑mail address, pretend to be someone other than
                        yourself, or otherwise mislead us or third-parties as to
                ...
                <div className={divStyle}>
                    ...
                    <h1>
                        ...
                        national origin, or disability; <br /> (f) to submit
                        ...
                        the Internet; <br /> (h) to collect or track the
                        personal information of others; <br /> (i) to spam,
                        phish, pharm, pretext, spider, crawl, or scrape; <br />
                ...
                <div className={divStyle}>
                    ...
                    <h1>
                        In no case shall Gramien'O, our directors, officers,
                        ...
                        service, even if advised of their possibility. Because
                ...
                <div className={divStyle}>
                    ...
                    <h1>
                        ...
                        Gramien'O and our parent, subsidiaries, affiliates,
                ...
                <hr />
                <div className={divStyle}>
                    <h1 className={boldFontStyle}>SECTION 15 - SEVERABILITY</h1>
                    <h1>
                ...
                <hr />
                <div className={divStyle}>
                    <h1 className={boldFontStyle}>SECTION 16 - TERMINATION</h1>
                    <h1>
                    ...
                    <h1>
                        ...
                        liable for all amounts due up to and including the date
                        of termination; and/or accordingly may deny you access
