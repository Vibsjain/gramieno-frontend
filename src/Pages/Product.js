					...
					<div className="w-full flex sm:flex-row flex-col sm:gap-0 gap-8 sm:mt-6 mt-0 items-center">
						<div className="sm:w-1/2 w-full flex gap-16 px-4">
							<div className="flex flex-col w-full gap-4 items-center">
								...
								>
									<img
										src={image ? image : product.mainImage}
										alt="table"
								...
								>
									<img
										...
										alt="table"
										className="w-16 h-16 rounded-lg cursor-pointer border border-blackborder-blue-400 hover:border-black"
										data-aos="zoom-in"
										onClick={() =>
											setImage(product.images[0])
										}
									...
									{product.images[1] && (
										<img
											...
											alt="table"
											className="w-16 h-16 rounded-lg cursor-pointer border border-blue-400 hover:border-black"
											data-aos="zoom-in"
											onClick={() =>
